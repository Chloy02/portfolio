      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-center">
        ...
        <div className="md:col-span-2">
          ...
          <p className="text-gray-400 mb-6 leading-relaxed">
            Leading choirs, organizing state-level Battle of the Bands, and
            performing for the university—music has always been my parallel
            passion. It&apos;s the other half of my creative core, a space for
            raw expression and connection. While I don&apos;t have tracks on
            Spotify yet, you can catch the vibe on my Instagram.
          </p>
          <a
